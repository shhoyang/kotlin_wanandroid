...
- [依赖注入Hilt](https://codelabs.developers.google.com/codelabs/android-hilt#0)
- [阿里路由框架ARouter](https://github.com/alibaba/ARouter)
- [AOP框架](https://github.com/HujiangTechnology/gradle_plugin_android_aspectjx)
- [腾讯X5WebView](https://x5.tencent.com)
